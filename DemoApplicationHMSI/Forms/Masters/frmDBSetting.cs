    ...
    public partial class frmDBSetting : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (txtSiteCode.Text.Trim() == "")
                {
                    blCommon.ShowMessage("Please enter site code.", 1);
                    txtSiteCode.Focus();
                }                
                else
                {
                    ...
                    wr.Close();
                    StreamWriter wr1 = new StreamWriter(Application.StartupPath + "\\SiteCode.ini");
                    wr1.WriteLine("SiteCode" + "~" + txtSiteCode.Text);
                    wr1.Close();
